...
def main():
    ...
    run_metalearner_for_each_outcome_and_model(TLearner, lgb.LGBMRegressor(), "LightGBM")
    run_metalearner_for_each_outcome_and_model(SLearner, lgb.LGBMRegressor(), "LightGBM")
    run_metalearner_for_each_outcome_and_model(DomainAdaptationLearner, lgb.LGBMRegressor(), "LightGBM")
    run_metalearner_for_each_outcome_and_model(XLearner, lgb.LGBMRegressor(), "LightGBM")
