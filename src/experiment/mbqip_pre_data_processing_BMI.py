...
if os.path.exists("../dat/mbqip/csv/BMI") == False:
    os.mkdir("../dat/mbqip/csv/BMI")
...
dataset_1.to_csv("../dat/mbqip/csv/BMI/mbqip_1.csv", header = False,index = False)
...
dataset_2.to_csv("../dat/mbqip/csv/BMI/mbqip_2.csv", header = False,index = False)
...
dataset_3.to_csv("../dat/mbqip/csv/BMI/mbqip_3.csv", header = False,index = False)
...
dataset_4.to_csv("../dat/mbqip/csv/BMI/mbqip_4.csv",header = False,index = False)
