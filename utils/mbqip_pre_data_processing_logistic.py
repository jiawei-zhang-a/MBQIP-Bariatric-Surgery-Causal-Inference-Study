...
dataset_1.to_csv("../dat/mbqip/csv/Death/mbqip_1.csv", header = False,index = False)
...
dataset_2.to_csv("../dat/mbqip/csv/Death/mbqip_2.csv", header = False,index = False)
...
dataset_3.to_csv("../dat/mbqip/csv/Death/mbqip_3.csv", header = False,index = False)
...
dataset_4.to_csv("../dat/mbqip/csv/Death/mbqip_4.csv", header = False,index = False)
